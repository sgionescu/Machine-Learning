...
for i = 1:20
    ...
    for j = (i + 1):20
        ...
        tic
        SVMStruct = svmtrain(train_data_binary, train_label_binary,'kernel_function','rbf','kernelcachelimit', 1000000, 'autoscale', 'false');
...
save('hw6_1f_results.mat', 'confusion_matrix', 'CCR', 'train_time', 'test_time')